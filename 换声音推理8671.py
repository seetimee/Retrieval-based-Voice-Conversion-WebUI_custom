...
with gr.Blocks(title='换声音') as app:
    with gr.Tabs():
            ...
            with gr.Group():
                ...
                with gr.Row():
                    with gr.Column():
                        ...
                        # )
                        input_audio0 = gr.Audio(type='filepath',label="上传待变声音频")
                        f0method0 = gr.Radio(
                    ...
                    with gr.Column():
                        ...
                        sid0.change(change_index,[sid0],[file_index1])
        ...
        #                 [vc_output4],
        #             )
        # with gr.TabItem(i18n("训练"),visible=False):
        #     gr.Markdown(
        #         value=i18n(
    ...
    #         quiet=True,
    #     )
    app.launch(share=False,server_name="0.0.0.0",server_port=8671)
